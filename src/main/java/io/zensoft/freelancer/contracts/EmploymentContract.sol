...
/** @title  Token (LNC) - Employment Contract code for the  Project */
contract EmploymentContract {
	...
	*/
    function EmploymentContract(string _link, address _client) {
        link=_link;
		client=_client;
	...
	*/
    function PayFreelancer(int _freelancerRating) external {
		...
		ContractHolder(DataHolder(aDataHolder).getContractHolder()).ContractFullfilled(client,freelancerRating);
	...
	*/
    function callTokenHolderTribunal(string reason) external {
        ...
        ContractHolder(DataHolder(aDataHolder).getContractHolder()).dispute();
    }
	...
	*/
    function finalizeDispute(){
        ...
        result=ContractHolder(DataHolder(aDataHolder).getContractHolder()).finalizeDispute();
